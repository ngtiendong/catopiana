...
class LocalStorageService
{
    ...
    {
        if($local_storage['guest_id'] != '0' && $local_storage['guest_id'] != '-1') {
            $this->deleteGuestTesting($local_storage['guest_id']);
        }
    ...
    private function deleteGuestTesting($guest_id)
    {
        $guest_test_ids = GuestTesting::where('guest_id', $guest_id)->get(['id'])->toArray();
        GuestTesting::destroy($guest_test_ids);
        return ;
    }
}
